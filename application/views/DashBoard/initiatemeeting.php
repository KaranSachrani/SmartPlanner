    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('DashBoard/index')?>">Sukkur IBA University</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <!-- /.navbar-top-links -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url('Login/index')?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                      ...
                      <li>
                        ...
                        <li>
                            <a href="<?php echo base_url('DashBoard/initiateMeeting')?>"><i class="fa fa-table fa-fw"></i> Initiate Meeting</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('DashBoard/showMeeting')?>"><i class="fa fa-edit fa-fw"></i> Forms</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="<?php echo base_url('Dashboard/save')?>">
